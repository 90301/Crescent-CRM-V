...
*/
	...
	public Location createLocation(String locationName) {
		...
		newLocationAllLocations.select(l);
	...
	public void populateAllLocationBoxes() {
		...
		//newLocationAllLocations.addAll();
...
/*
	...
	private void loadProximity(Location l) {
	    Collection<Location> locs = masterUi.userDataHolder.getAllLocations();
	    ArrayList<Location> listLocs = new ArrayList<Location>();
	    listLocs.addAll(locs);
		//editLocationProximitySelect.removeAllItems();
		editLocationProximitySelect.setItems(listLocs);
